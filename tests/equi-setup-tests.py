...
for src, mic_tri_side, source_dir in itertools.product(sources, mic_tri_sides, source_dirs):
    ...
    for i in range(3):
        ...
        csvwriter.writerow(["equi", mic_tri_side, src_amplitude, snr, "white", sound_name, source_dist, source_dir, direction, abs(source_dir-direction), sim_real_time, detection_time])

...
for snr in [-20, 0, 20]: #snr in db
    ...
    noise_snr.append((snr, "white", WhiteNoiseSoundSource(sample_rate, noise_amplitude)))
    noise_snr.append((snr, "pink", PowerLawNoiseSoundSource(sample_rate, 1, noise_amplitude)))

...
for src in sources:
    ...
    for amp in amplitudes:
        ...
        source_noise_pairs.append((snr, "white", name, type, amplitude, amp_factor))
...
for sound_noise, dir in itertools.product(source_noise_pairs, source_dirs):
    for i in range(4):
        snr, noise_type, sound_name, src_type, src_amplitude, amp_factor = sound_noise # unpack tuple
